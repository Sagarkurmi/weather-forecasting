...
This project is distributed under the GNU General Public License (GPL). You can find the full text of the license in the [LICENSE](https://github.com/Sagarkurmi/weather-forecasting/upload/main/LICENSE) file.
